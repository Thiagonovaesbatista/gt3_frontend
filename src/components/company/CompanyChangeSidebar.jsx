...
function CompanyChangeModal({
  ...
  return (
    <SidebarAdapter
      ...
      title={`${editing ? 'Alterar' : 'Cadastrar'} empresa`}
    >
    ...
    //       <h2>{`${editing ? 'Alterar' : 'Cadastrar'} empresa`}</h2>
    //     </div>
  ...
  //       <Button label="Cancelar" onClick={onCancel} disabled={isLoa
  // ding} className="p-button-text p-button-plain" />
  //       <Button
  //         label="Confirmar"
  //         type="submit"
  //         autoFocus
